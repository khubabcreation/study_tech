...
class ContainerWelcome1 extends StatefulWidget {
  const ContainerWelcome1({Key? key}) : super(key: key);
        ...
        body: Stack(
          children: [
            Container(
              height: height,
              width: width,
              child: Image.asset('assets/images/girlwatching.png',
                  fit: BoxFit.fill),
            ),
            Container(
              height: height,
              ...
              child: Column(
                ...
                children: [
                  ...
                  custome_txt(
                    height: height * 0.22,
                    title: "Saat kau terpuruk, percayalah",
                    color: Appcolors.white_custome,
                    fontfamily: 'ragular',
                  ),
                  custome_txt(
                    height: height * 0.22,
                    title: "bahwa ilmu yang sudah",
                    color: Appcolors.white_custome,
                    fontfamily: 'ragular',
                  ),
                  custome_txt(
                    height: height * 0.22,
                    title: "dipelajari akan berarti",
                    color: Appcolors.white_custome,
                    fontfamily: 'ragular',
                  ),
                  custome_txt(
